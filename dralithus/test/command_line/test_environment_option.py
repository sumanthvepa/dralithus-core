...
def make_cases() -> list[tuple[str, CaseData]]:
  ...
  return [
    ...
    ('long2_equal_value_no_next_arg', CaseData(args=['--environment=local', None], expected=EnvironmentOption('environment', {'local'}), error=None)),
    ('long2_equal_multi_value_no_next_arg', CaseData(args=['--environment=local,test', None], expected=EnvironmentOption('environment', {'local', 'test'}), error=None)),
    ('short_equal_value_next_arg', CaseData(args=['-e=local', 'parameter'], expected=EnvironmentOption('e', {'local'}), error=None)),
    ('short_equal_multi_value_next_arg', CaseData(args=['-e=local,test', 'parameter'], expected=EnvironmentOption('e', {'local', 'test'}), error=None)),
    ('long_equal_value_next_arg', CaseData(args=['--env=local', 'parameter'], expected=EnvironmentOption('env', {'local'}), error=None)),
    ('long_equal_multi_value_next_arg', CaseData(args=['--env=local,test', 'parameter'], expected=EnvironmentOption('env', {'local', 'test'}), error=None)),
    ('long2_equal_value_next_arg', CaseData(args=['--environment=local', 'parameter'], expected=EnvironmentOption('environment', {'local'}), error=None)),
    ('long2_equal_multi_value_next_arg', CaseData(args=['--environment=local,test', 'parameter'], expected=EnvironmentOption('environment', {'local', 'test'}), error=None)),
    ('short_next_arg_value', CaseData(args=['-e', 'local'], expected=EnvironmentOption('e', {'local'}), error=None)),
    ('short_next_arg_multi_value', CaseData(args=['-e', 'local,test'], expected=EnvironmentOption('e', {'local', 'test'}), error=None)),
    ('long_next_arg_value', CaseData(args=['--env', 'local'], expected=EnvironmentOption('env', {'local'}), error=None)),
    ('long_next_arg_multi_value', CaseData(args=['--env', 'local,test'], expected=EnvironmentOption('env', {'local', 'test'}), error=None)),
    ('long2_next_arg_value', CaseData(args=['--environment', 'local'], expected=EnvironmentOption('environment', {'local'}), error=None)),
    ('long2_next_arg_multi_value', CaseData(args=['--environment', 'local,test'], expected=EnvironmentOption('environment', {'local', 'test'}), error=None)),
