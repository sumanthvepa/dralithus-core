...
def make_cases() -> list[tuple[str, CaseData]]:
  ...
  return [
    ...
    ('long_bad_value_equal', CaseData(args=['--verbose=bad_value', None], error=AssertionError)),
    ('long_bad_value2_equal', CaseData(args=['--verbose=True', None], error=AssertionError)),
    ('long_bad_value3_equal', CaseData(args=['--verbose=-2', None], error=AssertionError)),
    ('long2_bad_value_equal', CaseData(args=['--verbosity=bad_value', None], error=AssertionError)),
    ('long2_bad_value2_equal', CaseData(args=['--verbosity=True', None], error=AssertionError)),
    ('long2_bad_value3_equal', CaseData(args=['--verbosity=-2', None], error=AssertionError)),
    ('short_bad_value_next_arg_negative', CaseData(args=['-v', '-2'], error=ValueError)),
    ('long_bad_value_next_arg', CaseData(args=['--verbosity=bad_value', 'parameter'], error=AssertionError)),
    ...
    ('wrong_long_option_no_value', CaseData(args=['--help', None], error=AssertionError)),
    ('wrong_long_option_value', CaseData(args=['--help=True', None], error=AssertionError)),
    ('wrong_short_option_next_arg', CaseData(args=['-h', '1'], error=AssertionError)),
    ('wrong_long_option_next_arg', CaseData(args=['--help', '1'], error=AssertionError)),
